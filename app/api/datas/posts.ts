export const posts = [
    ...
    landing: [
      {
        ...
        promo: [
          {
            id: 1,
            promoİmg: "/images/promo1.png",
          },
          {
            id: 2,
            promoİmg: "/images/promo2.png",
          },
          {
            id: 3,
            promoİmg: "/images/promo3.png",
          },
          {
            id: 4,
            promoİmg: "/images/promo4.png",
          },
        ]
      },
    ],
  },
  {
    about: [
      {
        bannerTitle: "WE AIM TO INSPIRE AND IGNITE THE SPARK IN YOU THAT MAKES YOU-YOU.",
        bannerİmg: "/images/aboutBanner.png",
        bannerText: "In our company, we re not just in the business of hats and caps; we're in the business of self-expression. Our collection goes beyond mere accessories – it's a celebration of individuality. We aim to inspire and ignite the spark in you that sets your style apart. Each hat is more than fabric and stitches; it's a statement, a reflection of your personality. Explore our curated selection of headwear, meticulously crafted to complement your uniqueness. Let your style shine, hat by hat, because in our company, we believe in the power of the perfect cap to make you feel authentically you." ,
        layoutText: "Step into a world where style meets versatility. İn our company, our passion for hats and caps goes beyond fashion; it's about crafting a statement piece that echoes your unique identity Our curated collection is a fusion of trends and tradition, offering a range of hats and caps that effortlessly elevate your look. From casual cool to sophisticated elegance, each piece is a testament to our commitment to quality and design Indulge in the spirit of self-expression with our handpicked selection. İn our company, we don't just offer hats; we provide a canvas for your individuality. Embrace the essence of timeless fashion and make a statement that's uniquely yours.",
        layoutİmg: "/images/layoutİnfo.avif",
      },
    ],
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        variations: [
          ...
          {
            src: "/images/Unisex The North Face Salty Dog Beanie1.png",
          },
          {
            src: "/images/Unisex The North Face Salty Dog Beanie2.png",
          }
        ],
        productSize: [
          {
      ...
      {
        id: 9,
        title: "Nike AeroBill Classic99",
        category: "caps",
        src: "/images/nike-AeroBill_Classic99_Cap1.png",
        price: "5,362",
        description: "Introducing the Nike AeroBill Classic99 Cap - a modern and sporty accessory designed for both performance and style. Crafted with Nike's advanced AeroBill technology, this cap combines comfort and functionality for your active lifestyle. Featuring a classic design with the iconic swoosh logo, it's a versatile addition to your sportswear collection. The AeroBill Classic99 Cap ensures a lightweight and breathable fit, making it perfect for workouts or casual outings. Elevate your headwear game with the dynamic fusion of technology and iconic design in the Nike AeroBill Classic99 Cap.",
        variations: [
          {
            src: "/images/nike-AeroBill_Classic99_Cap1.png",
          },
